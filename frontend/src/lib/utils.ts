...
/**
 * Merges CSS class names safely using clsx and tailwind-merge.
 * Solves class specificity conflicts in Tailwind components.
 */
 ...
 * Defaults to INR (₹) for garment manufacturing operations.
 */
