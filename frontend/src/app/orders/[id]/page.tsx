...
//       if (raw) {
//         // Dynamically map all database properties and fallback aliases
...
//                   sequenceOrder: 1,
//                   pieceRate: 5.0,
//                   completedPieces: raw.completedQuantity || 0,
//                 },
//                 {
//                   id: 'op-2',
...
//                 {
//                   id: 'bnd-1',
//                   bundleCode: `BND-${raw.orderNumber || '000'}-M`,
//                   size: 'M',
//                   color: 'Default',
//                   quantity: Math.ceil((raw.quantity || 100) / 2),
//                   status: 'IN_PROGRESS',
//                   currentOperation: 'Main Body Stitching',
//                   assignedWorker: 'Unassigned',
//                 },
//                 {
//                   id: 'bnd-2',
//                   bundleCode: `BND-${raw.orderNumber || '000'}-L`,
//                   size: 'L',
//                   color: 'Default',
//                   quantity: Math.floor((raw.quantity || 100) / 2),
//                   status: 'IN_PROGRESS',
//                   currentOperation: 'Main Body Stitching',
//                   assignedWorker: 'Unassigned',
//                 },
...
//               const opProgress = order.quantity > 0 ? Math.round((op.completedPieces / order.quantity) * 100) : 0;
//               return (
//                 <div
//                   key={op.id}
...
// Purpose: Detailed Job Order View with Operations Sequence and Manual Progress Entry
// Path: frontend/src/app/orders/[id]/page.tsx
...
//     try {
//       // 1. Update the specific operation in the local array safely
//       const updatedOperations = order?.operations?.map((op: any) => 
//         op.id === opId ? { ...op, completedPieces: newQty } : op
//       ) || [];

//       // 2. Send the updated operations list to the main order update route
